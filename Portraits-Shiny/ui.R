                    ...
                    div(class="outer",
                        ...
                        absolutePanel(id = "controls", class = "panel panel-default", fixed = TRUE,
                                ...
                                conditionalPanel(condition = "input.Echele == 'Secteurs des opérations régionales' && (input.Sousregions =='deux' || input.Sousregions =='trois')",
                                                 selectInput("Secteurs2", "Séléctionez le secteur 2:",
                                                             choices=SecteursC)),                
                                ...
                                conditionalPanel(condition = "input.Echele == 'Secteurs des opérations régionales' && input.Sousregions =='trois'",
                                                 selectInput("Secteurs3", "Séléctionez le secteur 3:",
                                                             choices=SecteursC)),                
                                conditionalPanel(condition = "input.Echele == 'Régions forestières' &&  input.Sousregions =='trois'",
                                                 selectInput("RegForest2", "Séléctionez la région 3:",
                                                             choices=RegForestC)),                
